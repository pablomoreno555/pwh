# Function that scans the environment and returns the list of all the objects detected in the scene
def get_objects(controller):
    ...
    # Perform a first scan from the initial position of the robot
    scan_objects()
